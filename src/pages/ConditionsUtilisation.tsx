...
const translations: Record<'fr' | 'en', ConditionsTranslations> = {
  fr: {
    ...
    sec3P1: "L'inscription et l'utilisation de DGhubSchool sont entièrement gratuites pour les établissements scolaires pendant la première année, sans aucun frais de licence ni de maintenance. À compter de la 2ème année, l'accès de l'établissement est conditionné au paiement d'une licence par élève, dont les modalités sont communiquées avant la fin de la première année. Le modèle économique du Service repose par ailleurs sur la contribution annuelle des comptes parents, conformément aux tarifs indiqués au sein du Service.",
    sec3BoxTitle: "Période de grâce applicable (Essai initial) :",
    sec3BoxItem1School: <><strong>Établissements scolaires (Écoles)</strong> : Bénéficient d'un accès complet et gratuit dès la création de leur compte, pendant la première année. À compter de la 2<sup>e</sup> année, l'accès est conditionné au paiement d'une licence par élève dont les modalités sont communiquées à l'établissement avant la fin de sa première année.</>,
    ...
    sec3Warning: "Si la contribution parentale n'est pas soldée à l'issue de la période de grâce et du délai accordé pour les tranches, l'accès au compte parent concerné sera automatiquement suspendu jusqu'au règlement de la somme due. De même, si la licence de l'établissement n'est pas réglée après la première année gratuite, l'accès de l'établissement pourra être suspendu jusqu'au règlement.",
  ...
  en: {
    ...
    sec3P1: "Registration and use of DGhubSchool are entirely free for schools during their first year, with no license or maintenance fees whatsoever. From year 2 onward, the school's access is conditioned on payment of a per-student license, with terms communicated before the end of the first year. The Service's economic model also relies on the annual contribution of parent accounts, in accordance with the rates indicated within the Service.",
    sec3BoxTitle: "Applicable Grace Period (Initial Trial):",
    sec3BoxItem1School: <><strong>School Institutions (Schools)</strong>: Benefit from full, free access starting from their account creation, for the first year. From year 2 onward, access is conditioned on payment of a per-student license, with terms communicated to the school before the end of its first year.</>,
    ...
    sec3Warning: "If the parental contribution is not settled by the end of the grace period and the installment deadline, access to the parent account concerned will be automatically suspended until the amount due is paid. Likewise, if the school's license is not settled after the free first year, the school's access may be suspended until payment.",
    sec4Title: "4. Maintenance & Support",
