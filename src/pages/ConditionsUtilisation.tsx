...
const translations: Record<'fr' | 'en', ConditionsTranslations> = {
  fr: {
    ...
    sec3P1: "L'utilisation de DGhubSchool pour les établissements et les parents est soumise à des frais de licence annuels conformément aux tarifs indiqués au sein du Service.",
    sec3BoxTitle: "Périodes de grâce applicables (Essai initial) :",
    sec3BoxItem1School: <><strong>Établissements scolaires (Écoles)</strong> : Bénéficient d'un report de paiement obligatoire et d'un accès complet sans restriction de <strong>90 jours</strong> à compter de la création de leur compte.</>,
    sec3BoxItem2Parent: <><strong>Comptes Parents</strong> : Bénéficient d'une période de grâce de <strong>14 jours</strong> après inscription pour lier et consulter les informations de leurs enfants avant l'activation requise d'une licence.</>,
    sec3Warning: "Afin de garantir l'équité, si un établissement dépasse sa limite d'élèves autorisée par son forfait, ou en cas de non-respect des règlements annuels après la période d'essai gratuite, l'accès complet à la plateforme sera automatiquement suspendu.",
  ...
  en: {
    ...
    sec3P1: "The use of DGhubSchool for institutions and parents is subject to annual license fees in accordance with the rates indicated within the Service.",
    sec3BoxTitle: "Applicable Grace Periods (Initial Trial):",
    sec3BoxItem1School: <><strong>School Institutions (Schools)</strong>: Benefit from a mandatory deferred payment and full, unrestricted access for <strong>90 days</strong> starting from their account creation.</>,
    sec3BoxItem2Parent: <><strong>Parent Accounts</strong>: Benefit from a grace period of <strong>14 days</strong> after registration to link and view their children's information before a license activation is required.</>,
    sec3Warning: "In order to ensure equity, if an institution exceeds its student limit allowed by its plan, or in case of non-payment of annual fees after the free trial period, full access to the platform will be automatically suspended.",
    sec4Title: "4. Maintenance & Support",
