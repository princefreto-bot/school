...
const TEXTS = {
  fr: {
    ...
    newsroomCardTitle2: "Attestation de scolarité générée en un clic",
    newsroomCardDesc2: "Nouveau : depuis la fiche de chaque élève, générez et imprimez son attestation de scolarité officielle (identité, classe, année scolaire, cachet et signature du directeur) — plus besoin de la rédiger à la main.",
    newsroomDate2: "Septembre 2026",
  ...
  en: {
    ...
    newsroomBadge2: "🚀 New",
    newsroomCardTitle2: "Proof-of-enrollment certificate in one click",
    newsroomCardDesc2: "New: from any student's file, generate and print their official proof-of-enrollment certificate (identity, class, school year, official stamp and director's signature) — no more drafting it by hand.",
    newsroomDate2: "September 2026",
