...
const TEXTS = {
  fr: {
    ...
    newsroomCardTitle2: "Statistiques élèves par âge/sexe + verso de carte personnalisable",
    newsroomCardDesc2: "Nouveau : le tableau de bord affiche la répartition de vos élèves par âge et par sexe, avec une page dédiée filtrable et imprimable. Les cartes scolaires reçoivent aussi un verso personnalisable (texte libre défini dans Paramètres) pour le règlement intérieur ou vos mentions légales.",
    newsroomDate2: "Août 2026",
  ...
  en: {
    ...
    newsroomBadge2: "🚀 New",
    newsroomCardTitle2: "Age/gender student stats + customizable ID card back",
    newsroomCardDesc2: "New: the dashboard shows your student body's breakdown by age and gender, with a dedicated filterable, printable page. School ID cards also get a customizable back side (free text set in Settings) for school rules or legal notices.",
    newsroomDate2: "August 2026",
