...
const TEXTS = {
  fr: {
    ...
    newsroomCardTitle2: "Portail Personnel : une connexion séparée pour tout le staff",
    newsroomCardDesc2: "Nouveau : enseignants, secrétariat, comptabilité, censeur, proviseur et surveillants se connectent désormais via un Portail Personnel dédié, distinct du Portail Établissement réservé à la direction. La secrétaire n'a plus accès au dashboard financier — les autres rôles migrés gardent leurs accès habituels.",
  ...
  en: {
    ...
    newsroomBadge2: "🚀 New",
    newsroomCardTitle2: "Staff Portal: a separate login for the whole team",
    newsroomCardDesc2: "New: teachers, secretariat, accounting, censeur, proviseur and supervisors now log in through a dedicated Staff Portal, separate from the School Portal reserved for management. Secretary accounts no longer see the financial dashboard — other migrated roles keep their usual access.",
