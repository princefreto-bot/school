...
const TEXTS = {
  fr: {
    ...
    newsroomCardTitle2: "Notes d'examens (CEPD, BEPC, BAC) et classement par section",
    newsroomCardDesc2: "Nouveau : un espace de saisie dédié aux sessions d'examen national pour les classes de CM2, 3ème, 1ère et Terminale, entièrement séparé des notes trimestrielles/semestrielles. Classement automatique par section, et les statistiques de réussite par type d'examen s'affichent désormais dans les Rapports Académiques. Tout inclus, toujours gratuit.",
  ...
  en: {
    ...
    newsroomBadge2: "🚀 New",
    newsroomCardTitle2: "Exam grades (CEPD, BEPC, BAC) with per-section ranking",
    newsroomCardDesc2: "New: a dedicated grade entry space for national exam sessions, for CM2, 3ème, 1ère and Terminale classes, fully separate from regular term grades. Automatic per-section ranking, and exam success-rate statistics now appear in Academic Reports. All included, still free.",
