...
const TEXTS = {
  fr: {
    ...
    newsroomCardTitle2: "Statistiques élèves par âge et par sexe, liste imprimable",
    newsroomCardDesc2: "Nouveau : le tableau de bord affiche désormais la répartition de vos élèves par âge et par sexe en un coup d'œil. Une page dédiée permet de filtrer par cycle ou par classe, consulter la liste détaillée et l'imprimer pour vos démarches administratives.",
  ...
  en: {
    ...
    newsroomBadge2: "🚀 New",
    newsroomCardTitle2: "Age and gender student statistics, printable roster",
    newsroomCardDesc2: "New: the dashboard now shows your student body's breakdown by age and gender at a glance. A dedicated page lets you filter by cycle or class, browse the detailed list, and print it for your administrative paperwork.",
