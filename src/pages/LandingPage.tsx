...
const TEXTS = {
  fr: {
    ...
    payrollDesc: "Calculez les bulletins de salaire de vos enseignants et employés en un clic : cotisations CNSS, AMU et impôt sur le revenu (IRPP) appliqués automatiquement selon le barème en vigueur. Chaque enseignant a son badge à scanner à l'entrée — les heures manquées sont calculées automatiquement et une retenue est proposée sur le bulletin, toujours validée par le directeur. Zéro calcul manuel, zéro erreur de charges sociales.",
    payrollBadge: "💵 Paie",
    ...
    newsroomCardTitle2: "Portail personnel, badges enseignants et documents numérisés",
    newsroomCardDesc2: "Nouveau ce mois-ci : espace « Mon Espace » pour tout le personnel (profil, bulletin, planning, absences), badges QR pour le pointage entrée/sortie des enseignants avec calcul automatique des heures manquées, retenue proposée sur le bulletin de paie, numérisation des documents du personnel, et un tout nouveau design pour les reçus et bulletins de paie. Tout inclus, toujours gratuit.",
  ...
  en: {
    ...
    payrollDesc: "Generate teacher and staff payslips in one click: social security (CNSS), health insurance (AMU) and income tax withholdings applied automatically per the current schedule. Every teacher gets a badge to scan at the school entrance — missed hours are calculated automatically and a deduction is proposed on the payslip, always reviewed by the principal. Zero manual calculation, zero payroll tax errors.",
    ...
    newsroomBadge2: "🚀 New",
    newsroomCardTitle2: "Staff portal, teacher badges and digitized documents",
    newsroomCardDesc2: "New this month: a \"My Space\" portal for all staff (profile, payslip, schedule, absences), QR badges for teacher clock-in/out with automatic missed-hours calculation, a proposed payroll deduction on the payslip, staff document digitization, and a brand-new design for receipts and payslips. All included, still free.",
