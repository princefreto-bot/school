...
const TEXTS = {
  fr: {
    ...
    newsroomCardTitle2: "Dépenses élève : Maillots, Excursions... suivies jusqu'au reçu",
    newsroomCardDesc2: "Nouveau : ajoutez des dépenses ponctuelles liées à un élève précis (maillots, excursion, fournitures...) à partir d'un catalogue de libellés réutilisable. Distinctes de l'écolage, elles apparaissent désormais, avec leur statut de paiement, directement sur le reçu de l'élève.",
  ...
  en: {
    ...
    newsroomBadge2: "🚀 New",
    newsroomCardTitle2: "Student Expenses: jerseys, field trips... tracked to the receipt",
    newsroomCardDesc2: "New: add one-off expenses tied to a specific student (jerseys, field trips, supplies...) from a reusable label catalog. Kept separate from tuition, they now show up — with their payment status — right on the student's receipt.",
