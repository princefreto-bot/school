      ...
      <main className="flex-1 max-w-4xl mx-auto px-6 py-20 w-full">
        <div className="space-y-6 mb-16 text-center">
          ...
          <p className="text-lg text-slate-500 dark:text-slate-400 font-medium max-w-2xl mx-auto">
            Comment pouvons-nous vous aider aujourd'hui ? Parcourez nos ressources ou contactez notre équipe.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          ...
          <div className="bg-white dark:bg-slate-900 border border-slate-200/60 dark:border-slate-800/80 rounded-3xl p-8 shadow-sm flex flex-col items-center text-center hover:border-amber-500/50 transition-colors">
            ...
            <h3 className="text-xl font-black text-slate-950 dark:text-white uppercase mb-4">Support par Email</h3>
            <p className="text-slate-500 dark:text-slate-400 text-sm mb-6">
              Notre équipe technique est disponible pour résoudre vos problèmes complexes.
            </p>
          ...
          <div className="bg-white dark:bg-slate-900 border border-slate-200/60 dark:border-slate-800/80 rounded-3xl p-8 shadow-sm flex flex-col items-center text-center hover:border-amber-500/50 transition-colors">
            ...
            <h3 className="text-xl font-black text-slate-950 dark:text-white uppercase mb-4">Documentation</h3>
            <p className="text-slate-500 dark:text-slate-400 text-sm mb-6">
              Consultez nos guides et tutoriels pour maîtriser la plateforme.
            </p>
        ...
        <div className="bg-slate-950 dark:bg-slate-900 rounded-3xl p-10 text-center relative overflow-hidden">
          <div className="relative z-10">
            <h3 className="text-2xl font-black text-white uppercase mb-4">Un problème urgent ?</h3>
            <p className="text-slate-400 mb-8 max-w-lg mx-auto">
              Si vous êtes administrateur d'un établissement, vous pouvez contacter directement votre gestionnaire de compte dédié.
            </p>
          </div>
          {/* Decors */}
