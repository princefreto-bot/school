...
const translations: Record<'fr' | 'en', ConfidentialiteTranslations> = {
  fr: {
    ...
    sec3Item1: <>Les bases de données sont hébergées sur une <strong>infrastructure cloud sécurisée</strong> et sont cryptées au repos et en transit via HTTPS/SSL.</>,
    ...
    sec3Item3: <>Un système d'authentification robuste empêche toute consultation non autorisée des données des élèves.</>,
  ...
  en: {
    ...
    sec3Item1: <>Databases are hosted on a <strong>secured cloud infrastructure</strong> and are encrypted at rest and in transit via HTTPS/SSL.</>,
    ...
    sec3Item3: <>A robust authentication system prevents any unauthorized access to student data.</>,
