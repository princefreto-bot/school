...
const featuresFr = [
  ...
  },
  {
    ...
    points: [
      ...
      'Attestation de scolarité générée en un clic, prête à imprimer',
  ...
  },
  {
    ...
    points: [
      ...
      'Import Excel des notes : modèle pré-rempli, aucune saisie manuelle',
      'Statistiques élèves par âge et par sexe, liste imprimable',
...
const featuresEn = [
  ...
  },
  {
    ...
    points: [
      ...
      'Proof-of-enrollment certificate generated in one click, print-ready',
  ...
  },
  {
    ...
    points: [
      ...
      'Bulk Excel grade import: pre-filled template, no manual entry',
      'Age and gender student statistics, printable roster',
  ...
  },
  {
    ...
    points: [
      ...
      'A "My Space" portal: profile, payslip, schedule and absences for all staff',
      ...
      'Separate Staff Portal: dedicated login for teachers, secretariat and accounting',
    ],
  },
  {
    image: '/DASH15.webp',
...
export const Features: React.FC = () => {
  ...
  const texts = {
    fr: {
      ...
      ctaDesc: 'Créez votre compte établissement gratuitement, sans engagement, avec une première année offerte, et découvrez toutes ces fonctionnalités en action.',
    ...
    en: {
      ...
      ctaDesc: 'Create your school account for free, no commitment, with a free first year, and discover all these features in action.',
