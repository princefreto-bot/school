...
export const ForgotPasswordParent: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-rose-50/50 via-white to-amber-50/50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 flex items-center justify-center p-4 font-['Poppins'] relative overflow-y-auto">
      ...
      <div className="w-full max-w-md bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-[32px] p-8 shadow-2xl shadow-slate-200/50 dark:shadow-black/50 text-center relative z-10 animate-in fade-in slide-in-from-bottom-8 duration-500">
        <div className="w-16 h-16 bg-rose-50 dark:bg-rose-950/30 border border-rose-100 dark:border-rose-900/50 text-rose-500 dark:text-rose-450 rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg shadow-rose-500/10">
