...
export const PortailEcole: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 text-slate-800 flex items-center justify-center font-['Poppins'] p-4 relative overflow-hidden">
      {/* Ambient glows */}
      ...
      <div ref={cardRef} className="w-full max-w-md bg-white/90 backdrop-blur-2xl border border-slate-100 rounded-[32px] p-6 md:p-10 shadow-2xl shadow-slate-200/50 relative z-10" style={{ willChange: 'transform, opacity' }}>
        ...
        <div className="text-center mb-8 portal-animate-item">
          <div className="w-16 h-16 bg-amber-50 border border-amber-100 rounded-none flex items-center justify-center mx-auto mb-4 shadow-lg shadow-amber-500/10 p-1">
            <img src="/logo.svg" className="w-full h-full object-contain" alt="DGhubSchool" />
          </div>
          <h1 className="text-2xl md:text-3xl font-black text-slate-900 tracking-tight">Portail Établissement</h1>
          <p className="text-slate-500 text-xs md:text-sm mt-1 font-medium">Éspace réservé à l'administration de l'école.</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <div className="bg-slate-50 border border-slate-100 rounded-2xl p-4 space-y-3 portal-animate-item">
          ...
          <div className="space-y-3 portal-animate-item">
            <div className="relative">
              ...
              <input 
                ...
                className="w-full pl-11 pr-4 py-3 bg-slate-50 border border-slate-200 focus:border-amber-500 focus:ring-1 focus:ring-amber-500 rounded-2xl text-xs md:text-sm focus:outline-none transition-colors text-slate-800 placeholder-slate-400"
                value={username} 
        ...
        <div className="mt-8 pt-6 border-t border-slate-100 flex flex-col gap-4 text-center portal-animate-item">
          <button 
          ...
          <button 
            ...
            className="text-[11px] font-bold text-slate-500 hover:text-slate-700 transition-colors pt-2 border-t border-slate-100"
          >
