...
const translations = {
  fr: {
    ...
    portalSubtitle: "Éspace réservé à la direction de l'école (administrateur, directeur).",
    ...
    accessPersonnel: "Accéder à l'espace Personnel",
  },
  en: {
    portalTitle: "School Portal",
    portalSubtitle: "Area reserved for school management (administrator, director).",
    ...
    accessPersonnel: "Access Staff Area",
  }
};
      ...
      <div ref={cardRef} className="w-full max-w-md bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-[32px] p-6 md:p-10 shadow-2xl shadow-slate-200/50 dark:shadow-black/50 relative z-10" style={{ willChange: 'transform, opacity' }}>
        ...
        <div className="mt-8 pt-6 border-t border-slate-100 dark:border-slate-800 flex flex-col gap-4 text-center portal-animate-item">
          ...
          <button
            ...
            className="text-[11px] font-bold text-slate-500 dark:text-slate-400 hover:text-slate-700 dark:hover:text-slate-300 transition-colors cursor-pointer"
          >
            {t('accessParent')}
          </button>
        </div>
