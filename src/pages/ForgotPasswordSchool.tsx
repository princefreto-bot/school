...
export const ForgotPasswordSchool: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100/80 flex items-center justify-center p-4 font-['Poppins']">
      <div className="w-full max-w-md bg-white border border-slate-100 rounded-[32px] p-6 md:p-10 shadow-2xl shadow-slate-200/50 animate-in fade-in zoom-in-95 duration-300">
        ...
        {message ? (
          <div className="text-center space-y-6">
            ...
            <button 
              ...
              className="w-full py-4 bg-slate-100 hover:bg-slate-200 text-slate-700 font-bold text-sm rounded-2xl transition"
            >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="relative">
              ...
              <input 
                ...
                className="w-full pl-11 pr-4 py-3 bg-slate-50 border border-slate-200 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 rounded-2xl text-sm focus:outline-none transition-colors text-slate-800"
                value={email} 
            ...
            <button 
              type="submit" 
              disabled={loading} 
              className="w-full py-4 bg-blue-500 hover:bg-blue-600 text-white font-black text-sm uppercase tracking-wider rounded-2xl shadow-xl shadow-blue-500/20 transition flex items-center justify-center gap-2 mt-4"
            >
            ...
            <button 
              type="button"
              onClick={() => navigate(`/${lang}/portail-ecole`)}
              className="w-full py-2 text-slate-500 text-xs font-bold flex items-center justify-center gap-2 mt-2 hover:text-slate-800 transition"
            >
