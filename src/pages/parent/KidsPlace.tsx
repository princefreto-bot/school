...
const videos: KidsVideo[] = [
  ...
  {
    id: 'v3',
    youtubeId: 'MMaec1fYeuA',
    title: 'Vocabulaire en Anglais',
    description: 'Une superbe vidéo éducative pour aider les enfants à apprendre du vocabulaire de base en anglais de manière amusante.',
    category: 'educatif',
    emoji: '🇬🇧',
    color: '#3B82F6',
    ageRange: '3–10 ans',
  ...
  {
    id: 'v5',
    youtubeId: 'ufxb8vvMgog',
    title: 'Les Jours de la Semaine',
    description: 'Une chanson entraînante pour apprendre les jours de la semaine (lundi, mardi, mercredi...) en s\'amusant !',
    category: 'educatif',
    emoji: '📅',
    color: '#EC4899',
    ageRange: '2–6 ans',
  ...
  {
    id: 'v6',
    youtubeId: 'z8otoGKmadI',
    title: 'Les contraires en Français',
    description: 'Petit, grand, chaud, froid... Découvre les antonymes et les contraires avec cette vidéo éducative complète !',
    category: 'educatif',
    emoji: '↔️',
    color: '#F97316',
    ageRange: '3–8 ans',
