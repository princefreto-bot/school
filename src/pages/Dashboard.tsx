...
export const Dashboard: React.FC = () => {
  ...
  const stats = useMemo(() => {
    ...
    // Frais d'inscription — piste distincte de l'écolage, jamais fondue dans les totaux
        ...
        <div className="pro-card p-6 bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl border border-indigo-200/40 dark:border-indigo-500/20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div className="bg-rose-50/80 dark:bg-rose-900/20 border border-rose-500/20 rounded-2xl p-4">
              ...
              <p className="text-xl font-black text-slate-900 dark:text-white">{maskValue(`${fmtMoney(stats.totalInscriptionRestant)} F`)}</p>
            </div>
          </div>
        </div>
      )}
