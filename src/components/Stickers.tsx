...
export const StickerStar: React.FC<StickerProps> = ({ className = '', style }) => (
  <svg className={className} style={style} width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
...
export const StickerHeart: React.FC<StickerProps> = ({ className = '', style }) => (
  <svg className={className} style={style} width="40" height="36" viewBox="0 0 40 36" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
...
export const StickerCurvedArrow: React.FC<StickerProps> = ({ className = '', style }) => (
  <svg className={className} style={style} width="64" height="48" viewBox="0 0 64 48" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
...
export const StickerCircle: React.FC<StickerProps> = ({ className = '', style }) => (
  <svg className={className} style={style} width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
...
export const StickerWave: React.FC<StickerProps> = ({ className = '', style }) => (
  <svg className={className} style={style} width="72" height="20" viewBox="0 0 72 20" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
...
export const StickerCheck: React.FC<StickerProps> = ({ className = '', style }) => (
  <svg className={className} style={style} width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
...
export const StickerNote: React.FC<StickerProps & { children?: React.ReactNode }> = ({ className = '', style, children }) => (
  <div className={className} style={style}>
    <div className="bg-amber-100/80 border border-amber-200/60 rounded-lg px-3 py-2 shadow-sm" style={{ maxWidth: 140 }}>
...
export const StickerSparkle: React.FC<StickerProps> = ({ className = '', style }) => (
  <svg className={className} style={style} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
...
export const StickerUnderline: React.FC<StickerProps> = ({ className = '', style }) => (
  <svg className={className} style={style} width="120" height="12" viewBox="0 0 120 12" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
...
export const StickerBang: React.FC<StickerProps> = ({ className = '', style }) => (
  <svg className={className} style={style} width="20" height="44" viewBox="0 0 20 44" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
