...
const NAV_ITEMS: Omit<NavItem, 'badge'>[] = [
  ...
  { id: 'espace_personnel',     label: 'Accueil',           icon: <LayoutDashboard className="w-[18px] h-[18px]" /> },
  { id: 'eleves',               label: 'Élèves',            icon: <Users className="w-[18px] h-[18px]" /> },
  { id: 'statistiques_eleves',  label: 'Statistiques Élèves', icon: <BarChart3 className="w-[18px] h-[18px]" /> },
  ...
  { id: 'paie',                 label: 'Paie',               icon: <Wallet className="w-[18px] h-[18px]" /> },
  ...
  { id: 'carte_personnel',      label: 'Cartes Personnel',  icon: <IdCard className="w-[18px] h-[18px]" /> },
  { id: 'scan_presence_personnel', label: 'Scan Entrée Personnel', icon: <ScanLine className="w-[18px] h-[18px]" /> },
  { id: 'scan_sortie_personnel',   label: 'Scan Sortie Personnel', icon: <ScanLine className="w-[18px] h-[18px]" /> },
  { id: 'carte_examen',         label: 'Cartes d\'Examen',  icon: <Award className="w-[18px] h-[18px]" /> },
  ...
  { id: 'mon_planning',         label: 'Mon Planning',      icon: <Calendar className="w-[18px] h-[18px]" /> },
  { id: 'mon_bulletin_paie',    label: 'Mon Bulletin de Paie', icon: <Wallet className="w-[18px] h-[18px]" /> },
  { id: 'mon_profil',           label: 'Mon Profil',        icon: <UserCircle className="w-[18px] h-[18px]" /> },
...
const NAV_GROUPS: Record<string, string> = {
  ...
  carte_personnel: 'Présences',
  scan_presence_personnel: 'Présences',
  scan_sortie_personnel: 'Présences',
  carte_examen: 'Présences',
  gestion_academique: 'Académique',
  emploi_du_temps: 'Académique',
  mon_planning: 'Mon Espace',
  mon_bulletin_paie: 'Mon Espace',
  mon_profil: 'Mon Espace',
